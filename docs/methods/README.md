...
One doc per method. A new pattern or tier-1 function adds a doc here in
the same pull request that ships it.

| Method | Kind | Doc |
| --- | --- | --- |
| jury | tier 2 pattern | [jury.md](jury.md) |
