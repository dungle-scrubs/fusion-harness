...
None open. The decision map (issue #1) closed all eight tickets; this RFC renders those decisions. npm publication remains a future product decision, outside this RFC's scope.
